...
#pragma mark 创建label
+(UILabel*)createLabelWithFrame:(CGRect)frame Font:(float)font Text:(NSString*)text andTextColor:(UIColor *)Tcolor andtextAlig:(NSTextAlignment)textAlig
{
...
+(UILabel*)createLabelWithFont:(float)font Text:(NSString*)text andTextColor:(UIColor *)Tcolor andtextAlig:(NSTextAlignment)textAlig
{
...
#pragma mark 创建button
+(UIButton*)createButtonWithFont:(float)font target:(id)target SEL:(SEL)method title:(NSString*)title withTextColor:(UIColor *)cusColor andImage:(UIImage *)cuImage
{
    UIButton *button=[UIButton buttonWithType:UIButtonTypeCustom];
    [button setTitle:title forState:UIControlStateNormal];
    [button setTitleColor:[UIColor blueColor] forState:UIControlStateNormal];
    button.titleLabel.font=[UIFont systemFontOfSize:font];
    [button setTitleColor:cusColor forState:UIControlStateNormal];
    [button setImage:cuImage forState:UIControlStateNormal];
    [button addTarget:target action:method forControlEvents:UIControlEventTouchUpInside];
    return button;
}
